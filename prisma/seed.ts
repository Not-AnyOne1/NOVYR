...
const PRODUCTS: SeedProduct[] = [
  ...
  { name: 'I Was Blind Tee', slug: 'i-was-blind-tee', description: 'I Was Blind Tee — oversized graphic tee in 240 GSM heavyweight combed cotton with a high-density, no-crack print. Boxy street silhouette, garment-washed for a broken-in feel. Free delivery anywhere in Morocco, cash on delivery.', imageKey: 'iwasblind', priceCents: 19900, collections: ['graphic', 'oversized'], sizes: TEE_SIZES, stock: [8, 14, 18, 16, 10, 4], flags: { isNewArrival: true } },
  // ── drop 008 (July 2026) ──
  { name: 'Make Love Make Art Tee', slug: 'make-love-make-art-tee', description: 'Make Love Make Art Tee — oversized graphic tee in 240 GSM heavyweight combed cotton with a high-density, no-crack print. Boxy street silhouette, garment-washed for a broken-in feel. Free delivery anywhere in Morocco, cash on delivery.', imageKey: 'makelove', priceCents: 19900, collections: ['graphic', 'oversized'], sizes: TEE_SIZES, stock: [8, 14, 18, 16, 10, 4], flags: { isNewArrival: true } },
  { name: 'The Hard Way Tee', slug: 'the-hard-way-tee', description: 'The Hard Way Tee — oversized graphic tee in 240 GSM heavyweight combed cotton with a high-density, no-crack print. Boxy street silhouette, garment-washed for a broken-in feel. Free delivery anywhere in Morocco, cash on delivery.', imageKey: 'hardway', priceCents: 19900, collections: ['graphic', 'oversized'], sizes: TEE_SIZES, stock: [8, 14, 18, 16, 10, 4], flags: { isNewArrival: true } },
  { name: 'Too Gucci Tee', slug: 'too-gucci-tee', description: 'Too Gucci Tee — oversized graphic tee in 240 GSM heavyweight combed cotton with a high-density, no-crack print. Boxy street silhouette, garment-washed for a broken-in feel. Free delivery anywhere in Morocco, cash on delivery.', imageKey: 'toogucci', priceCents: 19900, collections: ['graphic', 'oversized'], sizes: TEE_SIZES, stock: [8, 14, 18, 16, 10, 4], flags: { isNewArrival: true } },
  { name: 'Inspired By Fear Tee', slug: 'inspired-by-fear-tee', description: 'Inspired By Fear Tee — oversized graphic tee in 240 GSM heavyweight combed cotton with a high-density, no-crack print. Boxy street silhouette, garment-washed for a broken-in feel. Free delivery anywhere in Morocco, cash on delivery.', imageKey: 'inspiredfear', priceCents: 19900, collections: ['graphic', 'oversized'], sizes: TEE_SIZES, stock: [8, 14, 18, 16, 10, 4], flags: { isNewArrival: true } },
  { name: 'Red Lips Tee', slug: 'red-lips-tee', description: 'Red Lips Tee — oversized graphic tee in 240 GSM heavyweight combed cotton with a high-density, no-crack print. Boxy street silhouette, garment-washed for a broken-in feel. Free delivery anywhere in Morocco, cash on delivery.', imageKey: 'redlips', priceCents: 19900, collections: ['graphic', 'oversized'], sizes: TEE_SIZES, stock: [8, 14, 18, 16, 10, 4], flags: { isNewArrival: true } },
];
